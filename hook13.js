function method01() {
    ...
    let StringUtils = Java.use("com.bytedance.common.utility.StringUtils");
    StringUtils["encryptWithXor"].implementation = function (str) {
        console.log('encryptWithXor is called' + ', ' + 'str: ' + str);
        let ret = this.encryptWithXor(str);
